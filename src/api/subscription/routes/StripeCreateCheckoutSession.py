...
#First Party Imports
from src.variables.constants import FRONT_END_URL
...
tags=["Subscription"], operationId="createCheckoutSession")
    ...
    def get(self) -> dict:
        ...
        try:
            checkoutSession = stripe.checkout.Session.create(
                ...
                success_url=FRONT_END_URL + "success?session_id={CHECKOUT_SESSION_ID}",
                cancel_url=FRONT_END_URL + "cancel",
